...
getMember: function (message, toFind = "") {
  ...
  paginationEmbed: async function(msg, pages, emojiList = ['⏪', '⏩', "⏹"], timeout = 120000) {
    ...
    let actualpages = [];
    let embed = false;
    if(!msg.guild.me.permissionsIn(msg.channel).has("MANAGE_MESSAGES")) msg.channel.send("<a:error:885663139285327913> | **Note that I need the Permission, to remove REACTIONS**")
